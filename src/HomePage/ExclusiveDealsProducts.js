...
import ExclusiveItem from './ExclusiveItems';
import './NewArrival.css';

function ExclusiveDealsProducts() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await axios.get('http://localhost:8000/product/productCategoryIdentifier/exclusivedeals');
  ...
  return (
    <div className="newarrivals">
      <h2 className="newarrivals-h2">Exclusive Deals</h2>
...
export default ExclusiveDealsProducts;
